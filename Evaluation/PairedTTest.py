...
def generate_pdf_table(df1, df2, results, output_pdf):
    ...
    pdf.cell(200, 10, txt="Paired T-Test Analysis of ROUGE Scores for both STRUCTURED and UNSTRUCTURED", ln=True, align="C")
...
# Generate PDF table
output_pdf = "Evaluation/Rouge_Scores_PDF/TTest/Paired_T_Test_Results.pdf"
