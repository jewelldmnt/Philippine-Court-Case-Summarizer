...
def compute_rouge_scores(human_summary, ai_summary):
    """
    Compute ROUGE scores (recall, precision, F1) between human-generated and 
        AI-generated summaries.

    :param human_summary: The reference summary (human-generated).
    :param ai_summary: The candidate summary (AI-generated).
    :return: A dictionary containing ROUGE-1, ROUGE-2, and ROUGE-L scores with 
...
if __name__ == "__main__":
    ...
    for metric, values in scores.items():
        print(
            f"{metric.upper()} - Recall: {values['recall']:.4f}, 
