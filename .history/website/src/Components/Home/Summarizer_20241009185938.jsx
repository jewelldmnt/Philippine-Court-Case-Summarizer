...
const Summarizer = () => {
  ...
  const handleFileAdd = async (e) => {
    try {
      // Sending courtCaseLink as data to the server
      ...
      if (Array.isArray(response.data)) {
        // If it's an array, append it to the existing files
        setExistingFiles((prev) => [...prev, ...response.data]);
      } else if (response.data && typeof response.data === "object") {
        // If it's a single object, append it to the existing files
        setExistingFiles((prev) => [...prev, response.data]);
      } else {
