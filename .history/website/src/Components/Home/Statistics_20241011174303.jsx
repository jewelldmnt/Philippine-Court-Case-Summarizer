...
const Statistics = () => {
  ...
  const handleFileClick = (file) => {
    ...
    // Calculate word frequency list for the selected file
    const wordStats = calculateWordFrequencies(file.file_text);
    setWordStatsList(wordStats); // Store the list of top 10 word statistics

    // Calculate bigram frequency list for the selected file
    const bigramStats = calculateBigramFrequencies(file.file_text);
    setBigramStatsList(bigramStats); // Store the list of top 10 bigram statistics
  };
      ...
      <div className="bg-background text-white h-screen">
        ...
        <div className="grid grid-cols-[1fr,2fr,2fr] gap-x-10 h-fit m-8">
          ...
          <div className="flex flex-col space-y-6">
            <div className="bg-box rounded-xl py-6 w-full h-full max-h-[300px] p-4">
